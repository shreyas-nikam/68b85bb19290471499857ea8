...
st.sidebar.divider()
<<<<<<< HEAD
st.title("QuLab: SAR Drafting Assistant")
st.divider()
...
if 'case_data' not in st.session_state:
>>>>>>> a877ddf9f494e941a7581b5ccc32b8001803b9e0
...
<<<<<<< HEAD
page = st.sidebar.selectbox(label="Navigation", options=["Case Intake", "Explore Data", "Draft SAR (AI-augmented)", "Human Review", "Compliance Checklist & Sign-off", "Export & Audit"])
if page == "Case Intake":
...
''')
    ...
    run_page()
elif page == "Draft SAR (AI-augmented)":
