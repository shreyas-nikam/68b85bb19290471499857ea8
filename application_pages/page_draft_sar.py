...
def call_llm(prompt: str) -> str:
    if not LLM_API_KEY or LLM_API_KEY == "":
        ...
        return "AI-assisted draft:\nOn February 7, 2023, Customer 7 (Customer ID 7), a resident of the USA, initiated a transaction amounting to $810.94. This transaction (Transaction ID 889) originated from coordinates approximately Lat: 37.78, Lon: -122.18 and was destined for coordinates Lat: 37.19, Lon: -122.83. Subsequently, on February 17, 2023, Customer 7 conducted another transaction (Transaction ID 1143) for $480.43, originating from Lat: 41.21, Lon: -73.68 and directed towards Lat: 40.48, Lon: -74.10. The third transaction (Transaction ID 1577) occurred on March 7, 2023, with an amount of $624.92, originating from Lat: 34.37, Lon: -117.97 and destined for Lat: 33.69, Lon: -84.85.\n\nCustomer 7 has been identified as having a high-risk score of 82, which prompted the alert for suspicious activity. The transactions were conducted over a period of one month, involving different geographic locations across the USA. The pattern and frequency of these transactions, coupled with the customer's elevated risk score, necessitate further investigation to determine the legitimacy of the activities.\n\nThis SAR is filed to report the unusual transaction behavior of Customer 7, as the high-risk score and the nature of the transactions raise concerns about potential money laundering activities. Further analysis and monitoring of Customer 7's account and transactions are recommended to ensure compliance with AML regulations."
